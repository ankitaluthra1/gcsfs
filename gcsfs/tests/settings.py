...
BENCHMARK_PROCESSES_STR = os.environ.get(
    "GCSFS_BENCHMARK_PROCESSES", "16"
)  # comma separated list of process counts
BENCHMARK_PROCESSES = [int(s) for s in BENCHMARK_PROCESSES_STR.split(",") if s]

BENCHMARK_CHUNK_SIZE_MB = int(os.environ.get("GCSFS_BENCHMARK_CHUNK_SIZE_MB", "64"))
BENCHMARK_BLOCK_SIZE_MB = int(os.environ.get("GCSFS_BENCHMARK_BLOCK_SIZE_MB", "64"))
