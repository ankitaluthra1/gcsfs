...
single_threaded_directory_cases = [c for c in single_threaded_cases if "rename_files" not in c.name]
single_threaded_file_cases = [c for c in single_threaded_cases if "rename_files" in c.name]
